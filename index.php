...
<html>
 <head>
  <title>Файловая система PHP с Ajax JQuery</title>
 ...
 <body>
  <br /><br />
  <div class="container">
   <h2 align="center">Файловая система PHP с Ajax JQuery</h2>
   <br />
   <div align="right">
 ...
 <div class="modal-dialog">
  <div class="modal-content">
   ...
   <div class="modal-body">
    ...
    <input type="button" name="folder_button" id="folder_button" class="btn btn-info" value="Создать" />
...
$(document).ready(function(){
 ...
 $(document).on("click", ".update", function(){
  ...
  $('#action').val("change");
  $('#folderModal').modal("show");
  $('#folder_button').val('Изменить');
  $('#change_title').text("Изменить имя папки");
 });
